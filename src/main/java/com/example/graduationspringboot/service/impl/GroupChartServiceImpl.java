...
public class GroupChartServiceImpl implements GroupChartService {
    ...
    public Result R(GroupChartParam groupChartParam) {
        ...
        //八条判异准则的校验
        List<ResultOfCriterion> resultOfCriterionList = Criterion.ResultOfCriterionOfRAndS(groupRange,CL_R,LCL_R,UCL_R,rules,rulesKey);
    ...
    public Result S(GroupChartParam groupChartParam) {
        ...
        //八条判异准则的校验
        List<ResultOfCriterion> resultOfCriterionList = Criterion.ResultOfCriterionOfRAndS(data_S,CL_S,LCL_S,UCL_S,rules,rulesKey);
    ...
    @Override
    public Result delXbar(DelGroupChartParam groupChartParam) {
        String rules = groupChartParam.getRules();
        List<Integer> rulesKey = groupChartParam.getRulesKey();
        //将数据根据子组ID分为多个子组
        List<List<BigDecimal>> splitGroupData  = Calculate.splitGroup(groupChartParam.getGroupData(), groupChartParam.getGroupSize());
        ...
        //去除要删的组
        Collections.sort(groupChartParam.getDelPoint());
        for (int i = groupChartParam.getDelPoint().size()-1;i>=0;i--){
            if (i <= splitGroupData.size()){
                splitGroupData.remove((int)groupChartParam.getDelPoint().get(i));
            }
        }
        ...
        if (groupChartParam.getHistoryAve()!=null && groupChartParam.getHistoryAve()!=-1){
            ...
            cl = Calculate.CLOfDelXbar(splitGroupData);
        }
        //将cl值填充为List
        List<Double> CL_Xbar = new ArrayList<>();
        for (int i=0;i<splitGroupData.size();i++){
    ...
    @Override
    public Result delR(DelGroupChartParam groupChartParam) {
        String rules = groupChartParam.getRules();
        List<Integer> rulesKey = groupChartParam.getRulesKey();
        //将数据根据子组ID分为多个子组
        List<List<BigDecimal>> splitGroupData  = Calculate.splitGroup(groupChartParam.getGroupData(), groupChartParam.getGroupSize());
    ...
    @Override
    public Result delS(DelGroupChartParam groupChartParam) {
        String rules = groupChartParam.getRules();
        List<Integer> rulesKey = groupChartParam.getRulesKey();
        //将数据根据子组ID分为多个子组
        List<List<BigDecimal>> splitGroupData  = Calculate.splitGroup(groupChartParam.getGroupData(), groupChartParam.getGroupSize());
    ...
    @Override
    public Result delXbarR(DelGroupChartParam groupChartParam) {
        String rules = groupChartParam.getRules();
        List<Integer> rulesKey = groupChartParam.getRulesKey();
        //将数据根据子组ID分为多个子组
        List<List<BigDecimal>> splitGroupData  = Calculate.splitGroup(groupChartParam.getGroupData(), groupChartParam.getGroupSize());
    ...
    @Override
    public Result delXbarS(DelGroupChartParam groupChartParam) {
        String rules = groupChartParam.getRules();
        List<Integer> rulesKey = groupChartParam.getRulesKey();
        //将数据根据子组ID分为多个子组
        List<List<BigDecimal>> splitGroupData  = Calculate.splitGroup(groupChartParam.getGroupData(), groupChartParam.getGroupSize());
